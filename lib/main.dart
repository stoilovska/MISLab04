...
import 'package:mis_lab_03_201076/controllers/notification_controller.dart';
import 'package:mis_lab_03_201076/widgets/calendar_widget.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      initialRoute: '/',
      routes: {
        '/': (context) => const InitialListScreen(),
...
class InitialListScreen extends StatefulWidget {
  const InitialListScreen({super.key});

  @override
  InitialListScreenState createState() => InitialListScreenState();
}

class InitialListScreenState extends State<InitialListScreen> {
  final List<Exam> exams = [
    Exam(subject: 'MIS', dateTime: DateTime.now()),
    Exam(subject: 'EMT', dateTime: DateTime(2024, 02, 11)),
    Exam(subject: 'VNP', dateTime: DateTime(2024, 01, 11))
  ];
    ...
    return Scaffold(
      ...
      body: GridView.builder(
        ...
        itemBuilder: (context, index) {
          final course = exams[index].subject;
          final timestamp = exams[index].dateTime;
